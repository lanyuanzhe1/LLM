...
const Illustrations = (props: IllustrationsProp) => {
  ...
  // Vars
  const darkImg = withBasePath('/images/pages/misc-mask-dark.png')
  const lightImg = withBasePath('/images/pages/misc-mask-light.png')
      ...
      <>
        {typeof image1 === 'undefined' || isImageObj(image1) ? (
          <img
            ...
            src={image1?.src || withBasePath('/images/illustrations/objects/tree-1.png')}
        ...
        {typeof image2 === 'undefined' || isImageObj(image2) ? (
          <img
            ...
            src={image2?.src || withBasePath('/images/illustrations/objects/tree-2.png')}
