...
const connectedAccountsArr: ConnectedAccountsType[] = [
  ...
  },
  {
    ...
    logo: withBasePath('/images/logos/mailchimp.png')
  },
  {
    title: 'Asana',
    checked: false,
    subtitle: 'Task Communication',
    logo: withBasePath('/images/logos/asana.png')
  }
]
...
const socialAccountsArr: SocialAccountsType[] = [
  {
    title: 'Facebook',
    isConnected: false,
    logo: withBasePath('/images/logos/facebook.png')
  },
  {
    title: 'Twitter',
    isConnected: true,
    username: '@Theme_Selection',
    logo: withBasePath('/images/logos/twitter.png'),
  ...
  },
  {
    ...
    logo: withBasePath('/images/logos/linkedin.png'),
    href: 'https://in.linkedin.com/company/themeselection'
  },
  {
    title: 'Dribbble',
    isConnected: false,
    logo: withBasePath('/images/logos/dribbble.png')
  },
  {
    title: 'Behance',
    isConnected: false,
    logo: withBasePath('/images/logos/behance.png')
  }
]
