...
const rowsData: TableBodyRowType[] = [
  {
    avatarSrc: withBasePath('/images/avatars/1.png'),
  ...
  {
    avatarSrc: withBasePath('/images/avatars/2.png'),
    name: 'Richard Payne',
  ...
  {
    avatarSrc: withBasePath('/images/avatars/3.png'),
  ...
  {
    avatarSrc: withBasePath('/images/avatars/4.png'),
  ...
  {
    avatarSrc: withBasePath('/images/avatars/5.png'),
  ...
  {
    avatarSrc: withBasePath('/images/avatars/6.png'),
    name: 'Crystal Mays',
    username: '@crystal99',
  ...
  {
    avatarSrc: withBasePath('/images/avatars/7.png'),
    name: 'Mary Garcia',
  ...
  {
    avatarSrc: withBasePath('/images/avatars/8.png'),
    name: 'Megan Roberts',
    username: '@megan78',
